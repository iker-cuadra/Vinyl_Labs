  ...
  <header class="main-header">
    <div class="container-fluid d-flex align-items-center justify-content-between py-2 px-4">
      ...
      <div class="d-flex align-items-center gap-2">
        ...
        <?php else: ?>
          <a href="https://vinyl-labs.vercel.app/login.html" class="btn-login-custom">Iniciar sesión</a>
        <?php endif; ?>
  ...
  <div class="offcanvas offcanvas-start sidebar" tabindex="-1" id="menuLateral" aria-labelledby="tituloMenu">
    ...
    <div class="offcanvas-body">
      <nav class="nav flex-column">
        ...
        <?php else: ?>
          <a href="https://vinyl-labs.vercel.app/login.html" class="nav-link">Iniciar sesión</a>
        <?php endif; ?>
      </nav>
    </div>
  </div>
