  ...
  <div class="offcanvas offcanvas-start sidebar" tabindex="-1" id="menuLateral" aria-labelledby="tituloMenu">
    ...
    <div class="offcanvas-body">
      <nav class="nav flex-column">
        <a class="nav-link" href="https://vinyl-labs-8ei3g3yyd-iker-cuadras-projects.vercel.app/">Inicio</a>
      ...
      <div class="row gy-4">
        ...
        <div class="col-md-3 text-center text-md-start">
          ...
          <ul class="list-unstyled footer-links">
            <li><a href="https://vinyl-labs-8ei3g3yyd-iker-cuadras-projects.vercel.app/">Inicio</a></li>
